...
{
    internal class Iec608705MainConfigurationReadRepository : ExcelRepository<Iec608705MainConfigurationRowList, Iec608705MainConfigurationReadExcelAccess>, IIec608705MainConfigurationReadRepository
    {
        public Iec608705MainConfigurationReadRepository(Iec608705MainConfigurationReadExcelAccess excelAccess) : base(excelAccess)
        {
        }

        public async Task<Iec608705MainConfigurationRowList> ReadDataAsync(string path)
        {
